...
export const metadata: Metadata = {
  title: "Leave a Review | Hypnotherapy Roseville",
  description: "Leave Hypnotherapy Roseville a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/Cde3b_ooG8-VEAE/", kind: "google" },
  { label: "Leave a Yelp Review", href: "https://yelp.com/biz/hypnotherapy-roseville-lincoln", kind: "yelp" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Hypnotherapy Roseville and helps us keep improving.
        </p>
